...
#         # print max(size), resize_force and resize_max
#         # print(f"size: {size}, resize_force: {self.conf.resize_force}, resize_max: {self.conf.resize_max}")
...
#             'original_size': np.array(size_new),
...
#             # # print max of height and width in keypoints
#             # max_width_kpt = np.max(pred['keypoints'][:, 0])
#             # max_height_kpt = np.max(pred['keypoints'][:, 1])
#             # print(f"max_width_kpt: {max_width_kpt}, max_height_kpt: {max_height_kpt}")
#         if as_half:
#             for k in pred:
#                 if k == 'image_path':
#                     continue
